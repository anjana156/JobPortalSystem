...
using Domain.Application.Features.Profile.Interfaces;
using Domain.Models;
...
namespace Domain.Application.Features.Profile.Repositories
{
    public class ProfileRepository : IJobSeekerProfileRepository
    {
        protected readonly JobPortalDbContext _context;
        public ProfileRepository(JobPortalDbContext context)
        {
            _context = context;
        }
